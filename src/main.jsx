        ...
        <div className="workspace-grid">
          ...
          <section className="panel member-panel">
            {selectedGuild ? <>
              ...
              <div className="members-heading"><div><p className="section-kicker">MEMBERS <span>{filteredMembers.length}/{selectedGuild.members.length}</span></p><h3>メンバー</h3></div><label className="mini-search"><Icon name="search" size={16} /><input value={memberQuery} onChange={(event) => setMemberQuery(event.target.value)} placeholder="メンバー検索" aria-label="メンバー検索" /></label></div>
